...
function LandingPage(){
	useEffect(()=>{
		...
		const endpoint2 = `${API_URL1}metcoRegnVisitrDDList?ServiceKey=${API_KEY1}&numOfRows=10&pageNo=1&MobileOS=ETC&MobileApp=AppTesting&startYmd=20220513&endYmd=20220513&_type=json`
		fetch(endpoint2)
